...
class ProductsCard extends StatefulWidget {
  final user;
  final index;
  ProductsCard(this.user, this.index);
  @override
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child:  GestureDetector(
                                              onTap: () {
                                                _editDeleteBottomSheet(store.state.productList[widget.index]);
                                              },
                        ...
                        Center(
                          child: Container(
                            ...
                            child: 
                            store.state.productList[widget.index]['productImage']==null ||
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                  ...
                                  color: store.state.productList[widget.index]['discount'] != 0 || 
                                   store.state.productList[widget.index]['discount'] != "0"
                                      ? appColor
                                      : Colors.transparent,
                                  child: Text(
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          //  alignment: Alignment.center,
                            child: Text(store.state.productList[widget.index]['productName']==null?"":
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Center(
                                  ...
                                  //  alignment: Alignment.center,
                                    child: Text(
                                         store.state.productList[widget.index]['discountPrice']==null?
                                         "0.00 Tk":
                                         "${store.state.productList[widget.index]['discountPrice']} Tk",
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: appColor,
                             ...
                             store.state.productList[widget.index]['discount']==null
                                    ...
                                    : Expanded(
                                        child: Container(
                                          ...
                                          child: Text(
                                            "${store.state.productList[widget.index]['price']} Tk",
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                fontSize: 12,
                                                color: Colors.grey,
  ...
  void _editDeleteBottomSheet(d) {
   ...
   Future<Null> _showDeleteDialog(d) async {
    ...
    if (res.statusCode == 200) {
        ...
        store.state.productList.remove(d);
