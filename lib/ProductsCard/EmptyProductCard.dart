...
class EmptyProductCard extends StatefulWidget {
  final user;
  final index;
  EmptyProductCard(this.user, this.index);
  @override
  _EmptyProductCardState createState() => _EmptyProductCardState();
}

class _EmptyProductCardState extends State<EmptyProductCard> {
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              SlideLeftRoute(
                  page: EmptyStockProductDetails(widget.index)));
        },
        child: Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child:  GestureDetector(
                                              onTap: () {
                                                _editDeleteBottomSheet(store.state.emptyStockProductList[widget.index]);
                                              },
                        ...
                        Center(
                          child: Container(
                            ...
                            child: 
                            store.state.emptyStockProductList[widget.index]['productImage']==null ||
                            store.state.emptyStockProductList[widget.index]['productImage']==""?
                            Image.asset(
                            ...
                            CachedNetworkImage(
                                            imageUrl: CallApi().getUrl()+store.state.emptyStockProductList[widget.index]['productImage'],
                        ...
                        ////// <<<<< New tag start >>>>> //////
                     store.state.emptyStockProductList[widget.index]['discount']==0 ||
                     store.state.emptyStockProductList[widget.index]['discount']==null?
                     Container():
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                  ...
                                  child: Text(
                                    productDiscount != 0
                                        ? "${store.state.emptyStockProductList[widget.index]['discount']}% "+"Off"
                                        : "",
                                    style: TextStyle(
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          //  alignment: Alignment.center,
                            child: Text(store.state.emptyStockProductList[widget.index]['productName']==null?"":
                            store.state.emptyStockProductList[widget.index]['productName'],
                                maxLines: 1,
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Center(
                                  ...
                                  //  alignment: Alignment.center,
                                    child: Text(
                                         store.state.emptyStockProductList[widget.index]['discountPrice']==null?"0.00 Tk":
                                         "${store.state.emptyStockProductList[widget.index]['discountPrice']} Tk",
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: appColor,
                             ...
                             store.state.emptyStockProductList[widget.index]['discount']==null
                                    ...
                                    : Expanded(
                                        child: Container(
                                          ...
                                          child: Text(
                                            "${store.state.emptyStockProductList[widget.index]['price']} Tk",
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                fontSize: 12,
                                                color: Colors.grey,
  ...
  void _editDeleteBottomSheet(d) {
   ...
   Future<Null> _showDeleteDialog(d) async {
    ...
    if (res.statusCode == 200) {
        ...
        store.state.emptyStockProductList.remove(d);
