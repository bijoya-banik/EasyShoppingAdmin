...
import 'package:Easy_shopping_admin/ProductPage/OfferProductDetails.dart';
...
class OfferProductsCard extends StatefulWidget {
  final user;
  final index;
  OfferProductsCard(this.user, this.index);
  @override
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              SlideLeftRoute(
                  page: OfferProductDetails(widget.index)));
        },
        child: Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child:  GestureDetector(
                                              onTap: () {
                                                _editDeleteBottomSheet(store.state.offerProductList[widget.index]);
                                              },
                        ...
                        Center(
                          child: Container(
                            ...
                            child: 
                            store.state.offerProductList[widget.index]['productImage']==null ||
                            store.state.offerProductList[widget.index]['productImage']==""?
                            Image.asset(
                            ...
                            CachedNetworkImage(
                                            imageUrl: CallApi().getUrl()+store.state.offerProductList[widget.index]['productImage'],
                        ...
                        ////// <<<<< New tag start >>>>> //////
                     store.state.offerProductList[widget.index]['discount']==0 ||
                     store.state.offerProductList[widget.index]['discount']==null?
                     Container():
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                  ...
                                  child: Text(
                                    productDiscount != 0
                                        ? "${store.state.offerProductList[widget.index]['discount']}% "+"Off"
                                        : "",
                                    style: TextStyle(
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          //  alignment: Alignment.center,
                            child: Text(store.state.offerProductList[widget.index]['productName']==null?"":
                            store.state.offerProductList[widget.index]['productName'],
                                maxLines: 1,
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Center(
                                  ...
                                  //  alignment: Alignment.center,
                                    child: Text(
                                         store.state.offerProductList[widget.index]['discountPrice']==null?"0.00 Tk":
                                         "${store.state.offerProductList[widget.index]['discountPrice']} Tk",
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: appColor,
                             ...
                             store.state.offerProductList[widget.index]['discount']==null
                                    ...
                                    : Expanded(
                                        child: Container(
                                          ...
                                          child: Text(
                                            "${store.state.offerProductList[widget.index]['price']} Tk",
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                fontSize: 12,
                                                color: Colors.grey,
  ...
  void _editDeleteBottomSheet(d) {
   ...
   Future<Null> _showDeleteDialog(d) async {
    ...
    if (res.statusCode == 200) {
        ...
        store.state.offerProductList.remove(d);
