...
class _EditCategoryState extends State<EditCategory> {
  ...
  void initState() {
    ...
    nameController.text = widget.data['categoryName']==null?"":widget.data['categoryName'];
    _cover = widget.data['categoryImage']==null?"":widget.data['categoryImage'];
  ...
  void _editCategory() async {
    if (nameController.text.isEmpty) {
      ...
      return _showMsg("Upload categoty image");
    }
    ...
    var res = await CallApi().postData(data, '/api/editCategory');
      ...
      if (res.statusCode == 200) {
        ...
        for(var d in store.state.categoryList){
          if(d['id']==widget.data['id']){
            ...
            d["categoryName"]= body['categoryName'];
            d["categoryImage"]= body['categoryImage'];
            break;
