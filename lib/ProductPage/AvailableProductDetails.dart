...
class AvailableProductDetails extends StatefulWidget {
  final index;
  AvailableProductDetails(this.index);
  @override
  State<StatefulWidget> createState() {
    return AvailableProductDetailsState();
  }
}

class AvailableProductDetailsState extends State<AvailableProductDetails> {
                        ...
                        children: <Widget>[
                           Container(
                              ...
                              children: [
                                ...
                                Text(
                                  store.state.availableProductList[widget.index]['category'] == null
                                      ? ""
                                      : store.state.availableProductList[widget.index]['category']['categoryName'],
                                  textAlign: TextAlign.justify,
                                  style: TextStyle(
